<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UninformedSearch_WithCongestion.aspx.cs" Inherits="UninformedSearch_WithCongestion" %>
            ...
            <div class="row" style="background:#E3EDFA">
                ...
                <form id="Form1" runat="server">
                 ...
                 <asp:HiddenField ID="hfReturnValue" runat="server" />
                    ...
                    <asp:HiddenField ID="hfCongestionPercent" runat="server" />

                 <asp:Button runat="server" ID="btnSample" Text="" style="display:none;"  OnClick="btnSample_Click1" />
                    <asp:Label ID="Label1" runat="server" Text="Search Start Time: "></asp:Label>
                    <asp:Label ID="lblStartTime" runat="server" Text=""></asp:Label><br />
                   <asp:Label ID="Label2" runat="server" Text="Parking found, End Time: "></asp:Label>
                    <asp:Label ID="lblEndTime" runat="server" Text=""></asp:Label><br />
                   
                    <asp:Label ID="lblAlgoTime" runat="server" Text=""></asp:Label><br />
                     <asp:Button ID="btnTestData" runat="server" Text="Show Test Results" OnClick="btnTestData_Click" />
                    </form>

/*
 * FileName: RealTime.aspx.cs
 * This page contains the Algorithm Implementation for finding parking based on Real Time Data without considering Congestion
 * 
 * */
...
public partial class _Default : System.Web.UI.Page
{
    ...
    //:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::://
    //---- Function to find the parking using Gravitation Pull ---------------------//
    //:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::://
    public void findParking()
    {
        try
        {
            ...
            DateTime datetime2;
            datetime2 = Convert.ToDateTime(hfTime.Value); // between 7001 and 7002
            ...
            while (flag == false && int_trav <= numberoftimes)
            {
                ...
                // get the neighbors of the source from the pre computed data
                    ...
                    foreach (JObject o in a.Children<JObject>())
                    {
                        ...
                        foreach (JProperty p in o.Properties())
                        {
                            ...
                            if (avialbilty != 0)
                            {
                                ...
                                string destinationFound = bllObject.getParkingLocationFromNodeId(intersection1);
                                ...
                                functioncount++;
                                Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction" + functioncount, "calcRoute('" + originalLoc + "','" + destinationFound + "')", true);
                                flag = true;
                                break;
                            }
                            else
    ...
    void getDataFromExcel()
    {
        ...
        {
            connection.Open();
            OleDbCommand command = new OleDbCommand("select * from [RealTime$]", connection);
            ...
            using (OleDbDataReader dr = command.ExecuteReader())
            {
                while (dr.Read())
                {
                    ...
                    {
                        DateTime datetime2;
                        datetime2 = Convert.ToDateTime( dr[3].ToString()); 
                        ...
                        bllObject.insertTestData(Convert.ToDecimal(dr[1]), Convert.ToDecimal(dr[2]), Convert.ToDecimal(destination.Split(',')[0]), Convert.ToDecimal(destination.Split(',')[1]), startTime, times,travelDist,travelTime);
